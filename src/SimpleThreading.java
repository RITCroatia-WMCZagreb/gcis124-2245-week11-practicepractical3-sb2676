...
public class SimpleThreading {
    ...
    public SimpleThreading(){//make constructor
...
public class SimpleThreading {
    ...
    public SimpleThreading(){//make constructor
        ArrayList<Thread> threads = new ArrayList<Thread>();//make array to store threads
        ...
        for(Thread t: threads){//to print the end counter=0
            try {
                t.join();//waits for all threads to terminate
            } catch (InterruptedException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
